...
})({"7Fy9I":[function(require,module,exports,__globalThis) {
var Refresh = require("4a929cc1a32fc08e");
var ErrorOverlay = require("6ae5524af880b852");
...
},{"4a929cc1a32fc08e":"8JbJ8","6ae5524af880b852":"2oUtB"}],"8JbJ8":[function(require,module,exports,__globalThis) {
'use strict';
module.exports = require("411b43866bb95dd9");

},{"411b43866bb95dd9":"8Ou7T"}],"8Ou7T":[function(require,module,exports,__globalThis) {
/**
 * @license React
...
},{}],"2oUtB":[function(require,module,exports,__globalThis) {
var process = require("2c076a353ba5797");
!function(e, t) {
    module.exports = t();
}(window, function() {
    return function(e) {
...
},{"2c076a353ba5797":"d5jf4"}],"d5jf4":[function(require,module,exports,__globalThis) {
...
},{}],"kBWJi":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "d7b763c902fdfa5f";
"use strict";
...
},{}],"2gStk":[function(require,module,exports,__globalThis) {
...
//   }
// }
const MultipleReducers = (0, _redux.combineReducers)({
...
_c = CustomCombineReducer;
const store = (0, _redux.createStore)(MultipleReducers2, window.__REDUX_DEVTOOLS_EXTENSION__?.());
...
// Actiom Creators 
store.dispatch((0, _cartReducer.increaseItemQuantity)(4, 100));
store.dispatch((0, _cartReducer.decreaseItemQuantity)(4));
// store.dispatch({
...
store.dispatch({
    type: ACTIONS.WISHLIST_REMOVE,
    payload: {
        productId: 4
    }
});
var _c;
$RefreshReg$(_c, "CustomCombineReducer");

},{"redux":"anWnS","./productsList":"lBc2M","./productReducer":"67On0","./cartReducer":"kNTZ9","./wishListReducer":"b4mlo","@parcel/transformer-js/src/esmodule-helpers.js":"c85qP"}],"anWnS":[function(require,module,exports,__globalThis) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"c85qP"}],"c85qP":[function(require,module,exports,__globalThis) {
...
},{}],"lBc2M":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"c85qP"}],"67On0":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"./productsList":"lBc2M","@parcel/transformer-js/src/esmodule-helpers.js":"c85qP"}],"kNTZ9":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
// Action creaters
...
function increaseItemQuantity(productId, quantity = 1) {
    return {
        type: (0, _script.ACTIONS).INCRASE_QTY,
        payload: {
            productId,
            quantity
        }
...
function decreaseItemQuantity(productId, quantity = 1) {
    return {
        type: (0, _script.ACTIONS).DECRASE_QTY,
        payload: {
            productId,
            quantity
        }
...
function CartReducer(state = [], action) {
    const { type, payload } = action;
    switch(type){
        case (0, _script.ACTIONS).WISHLIST_ADD:
            // Add the item to the wishlist
            return [
                ...state,
                payload
            ];
        case (0, _script.ACTIONS).WISHLIST_REMOVE:
...
},{"./Script":"2gStk","@parcel/transformer-js/src/esmodule-helpers.js":"c85qP"}],"b4mlo":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
function WishlistReducer(state = [], action) {
    ...
    switch(type){
        case (0, _script.ACTIONS).ADD_TO_CART:
            return [
                ...state,
                payload
            ];
        case (0, _script.ACTIONS).REMOVE_FROM_CART:
            return state.filter((ele)=>ele.productId !== payload.productId);
        case (0, _script.ACTIONS).INCRASE_QTY:
            return state.map((ele)=>{
                if (ele.productId === payload.productId) return {
                    ...ele,
                    quantity: ele.quantity += payload.quantity
                };
                return ele;
            });
        case (0, _script.ACTIONS).DECRASE_QTY:
            return state.map((ele)=>{
                if (ele.productId === payload.productId) return {
                    ...ele,
                    quantity: ele.quantity -= payload.quantity
...
},{"./Script":"2gStk","@parcel/transformer-js/src/esmodule-helpers.js":"c85qP"}]},["7Fy9I","kBWJi","2gStk"], "2gStk", "parcelRequire94c2")

//# sourceMappingURL=index.02fdfa5f.js.map
